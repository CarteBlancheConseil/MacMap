...
// 
// -----------
bool bViewMgr::set_current(long idx){
...
// 
// -----------
bool bViewMgr::duplicate(long idx){
...
// 
// -----------
void bViewMgr::get_name(long idx, char* name){
bViewContainer* v;
	if(!_elts.get(idx,&v)){
		return;
	}
...
// 
// -----------
bool bViewMgr::set_name(long idx, const char* name){
...
// 
// -----------
bGenericXMLBaseElement* bViewMgr::get_root(long idx){
bViewContainer* v;
	if(!_elts.get(idx,&v)){
		return(NULL);
	}
