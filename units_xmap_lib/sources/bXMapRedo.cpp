...
// File : bXMapRedo.cpp
// Project : MacMap
// Purpose : C++ source file : XMap class, redo
...
// Constructeur
// ------------
bXMapRedo::bXMapRedo(bGenericXMLBaseElement* elt, bGenericMacMapApp* gapp, CFBundleRef bndl) 
...
// Constructeur
// ------------
bGenericXMLBaseElement* bXMapRedo::create(bGenericXMLBaseElement* elt){
	return(new bXMapRedo(elt,_gapp,elt->getbundle()));
}

// ---------------------------------------------------------------------------
// 
// ------------
void bXMapRedo::open(int* flags){
	bStdXMap::open(flags);
	_bsz=256;
	_buffer=malloc(_bsz);
}
...
// 
// ------------
bool bXMapRedo::process(int msg, void* prm){
...
// 
// ------------
void bXMapRedo::process_event(bGenericEvent* evt, bStdWait& wt){
