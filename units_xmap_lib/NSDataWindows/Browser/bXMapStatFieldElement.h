//----------------------------------------------------------------------------
// File : bXMapStatFieldElement.h
// Project : MacMap
// Purpose : Header file : Geographic object simulator class for browser using fields or matrix data
...
#ifndef __bXMapStatFieldElement__
#define __bXMapStatFieldElement__
...
class bXMapStatFieldElement : public bGenericGeoElement{
	public:
		bXMapStatFieldElement					(	);
		virtual ~bXMapStatFieldElement			(	);
