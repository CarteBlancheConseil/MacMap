//----------------------------------------------------------------------------
// File : bvDefVirtualStyle.h
// Project : MacMap
// Purpose : Header file : Base class for virtual styles
...
#ifndef __bvDefVirtualStyle__
#define __bvDefVirtualStyle__
...
class bvDefVirtualStyle{
public:
    bvDefVirtualStyle				(	bGenericMacMapApp* gapp);
    virtual ~bvDefVirtualStyle		(	);
