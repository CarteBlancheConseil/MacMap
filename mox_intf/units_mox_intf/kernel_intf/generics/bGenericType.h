...
public:
    ...
    virtual int index						(	)=0;
    virtual int kind						(	)=0;
    virtual long nb_rec						(	)=0;
    virtual long nb_live                    (	)=0;
    virtual long nb_killed					(	)=0;

    virtual bool load_object				(	long o,
                                                bool *b)=0;
    virtual bool load_object				(	long o,
    ...
    virtual long nb_sel						(	)=0;
    virtual void inc_sel					(	long n)=0;
    
    virtual long nb_cont					(	)=0;
    virtual void inc_cont					(	long n)=0;
